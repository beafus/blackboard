...
<?php
   ...
   echo' <div class="container-narrow">';
    ...
    echo'      <li class="active"><a href= "index.php?option=user&view=students_list" >Students</a></li>';
     echo'      <li ><a href="index.php?option=subject&view=subjects_list">Subjects</a></li>';
