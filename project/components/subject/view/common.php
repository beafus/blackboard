...
<?php
   ...
   echo' <div class="container-narrow">';
    ...
    echo'      <li ><a href= "index.php?option=user&view=students_list" >Students</a></li>';
     echo'      <li class="active"><a href="index.php?option=subject&view=subjects_list">Subjects</a></li>';
     ...
     echo' <hr>';
      ...
      echo'  <a class="btn btn-large btn-success" href="index.php?option=subject&view=subjects_list">Check the subjects!</a>';
      echo'</div>';
